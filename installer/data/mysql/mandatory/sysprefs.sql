...
('DuplicateBiblioSet003', '', NULL, 'If set, editing a biblio record as a new record will set control field 003 to this value and generate a locally unique 001', 'Free'),
...
('IntranetGroupedLibrarySelect', '0', '', 'Dropdowns for library selection will be grouped by library group in the staff client.', 'YesNo'),
...
('itemBarcodeInputFilter','','whitespace|T-prefix|cuecat|libsuite8|EAN13|truncate-plessey','If set, allows specification of a item barcode input filter','Choice'),
...
('OPACGroupedLibrarySelect', '0', NULL, 'Dropdowns for library selection will be grouped by library group in the OPAC.', 'YesNo'),
...
('SIPSameUserID','0','','Return the same user identity in SIP reply as was sent in the sip request to identify the patron.','YesNo'),
